...
1. **Domain Scout**: Uses Tavily API to find niche frontiers.
2. **Question Generator**: Formulates complex, multi-source research questions.
3. **Experiment Designer**: Devises formal hypotheses and methodologies.
4. **Critic Agent**: Checks for logic flaws and statistical validity.
5. **Uncertainty Agent**: Decides whether to finalize the paper or iterate based on confidence.
6. **Paper Generator**: Synthesizes the final findings into a professional Markdown report.
